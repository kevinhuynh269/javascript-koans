...
describe("About Higher Order Functions", function () {
  ...
  //Basically result will be flattened so it will be [0,1,2]
  //Then you will map it so it will apply the call back function which will add 1 to every value [1,2,3]
  //Then you Reduce which has an accumlator and a current value so it will be 6
